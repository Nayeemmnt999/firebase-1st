                            ...
                            <div className="p-6 sm:p-16">
                                ...
                                <div className="mt-16 grid space-y-4">
                                    ...
                                    <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300
                                     hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                                        <div className="relative flex items-center space-x-4 justify-center">
                                            <img src="https://www.iconpacks.net/icons/1/free-mail-icon-142-thumb.png" className="absolute left-0 w-5" alt="Facebook logo" />
                                            <span className="block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with E-mail</span>
                                        </div>
                                    </button>
                                    </Link>
